...
\*   \*\*PLC 시리즈 선택:\*\* Q 시리즈(3E), L 시리즈(3E), FX5U(3E), FX 시리즈(3E), iQ-R 시리즈(4E), iQ-F 시리즈(4E) 등 프로토콜 규격 선택 가능.
...
| \*\*Series\*\* | 프로토콜 타입 선택 | `Q Series (3E)`, `L Series (3E)`, `FX5U (3E)`, `FX Series (3E)`, `iQ-R Series (4E)`, `iQ-F Series (4E)` |
